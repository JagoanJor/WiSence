...
namespace API.Services
{
    ...
    public class AttendanceService : IAttendanceService<Attendance>
    {
        ...
        public Attendance ClockIn(User user)
        {
            ...
            try
            {
                var WorkHour = context.WorkingHours.FirstOrDefault();
                if (WorkHour == null)
        ...
        public WorkingHour SetWorkingHour(WorkingHour data)
        {
            ...
            try
            {
                var CurrentWorkingHour = context.WorkingHours;
                if (CurrentWorkingHour != null)
                    context.WorkingHours.RemoveRange(CurrentWorkingHour);

                context.WorkingHours.Add(data);
                context.SaveChanges();
