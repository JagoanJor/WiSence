...
namespace API.Services
{
    public class VendorService : IService<Vendor>
    {
        ...
        public bool Delete(Int64 id, String userID)
        {
            ...
            try
            {
                var obj = context.Vendors.FirstOrDefault(x => x.ID == id && x.IsDeleted != true);
        ...
        public Vendor Edit(Vendor data)
        {
            ...
            try
            {
                var obj = context.Vendors.FirstOrDefault(x => x.ID == data.ID && x.IsDeleted != true);
        ...
        public Vendor GetById(Int64 id)
        {
            ...
            try
            {
                return context.Vendors.FirstOrDefault(x => x.ID == id && x.IsDeleted != true);
            }
            catch (Exception ex)
            {
                Trace.WriteLine(ex.Message);
