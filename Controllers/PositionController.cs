...
namespace API.Controllers
{
    ...
    public class PositionController : ControllerBase
    {
        ...
        public PositionController(IServiceAsync<Position> service, IAuthService authService)
        {
            _service = service;
        ...
        public async Task<IActionResult> Get(int limit = 0, int page = 0, string search = "", string sort = "", string filter = "", string date = "")
        {
            try
            {
                ...
                var access = _authService.CheckRoleAccesibility(user.RoleID, "Perusahaan - Posisi");
            ...
            catch (Exception ex)
            {
                ...
                Trace.WriteLine(message, "PositionController");
